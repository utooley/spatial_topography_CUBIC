...
#run this with qsub -l h_vmem=50.0G,s_vmem=49.7G -j y -o ${SPATIAL_TOPOGRAPHY}/output/job_output/ -cwd /cbica/projects/spatial_topography/code/yeo_networks/yeo_clustering_n544_1000x.csh

set output_dir = "/cbica/projects/spatial_topography/data/imageData/yeo_clustering_networks/yeo7_n544_2runsonly_1000tries"
set cluster_out = "${output_dir}/yeo7_n544_2runsonly_1000tries" #CHANGE THIS!
set orig_data_dir = "${ABCD_DATA}/bids_release2_site14site20/derivatives/surfaces"
set sub_list = "/cbica/projects/spatial_topography/data/subjLists/release2/site14site20/yeo_networks/n544_site14site20_subjlist_tworunsonly.txt"
set surf_list = "/cbica/projects/spatial_topography//data/subjLists/release2/site14site20/yeo_networks/n544_site14site20_fullpaths_tworunsonly.csv"
set sub_dir = "${ABCD_DATA}/bids_release2_site14site20/derivatives/surfaces"
